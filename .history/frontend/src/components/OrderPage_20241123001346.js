...
const OrderPage = () => {
  ...
  // Set restaurant_id based on the dishes in the cart
  useEffect(() => {
    if (cart.length > 0) {
      ...
      } else if (allRestaurantIds.length === 1) {
        console.log('Setting restaurant_id:', allRestaurantIds[0]);
        setRestaurantId(allRestaurantIds[0]);
      } else {
