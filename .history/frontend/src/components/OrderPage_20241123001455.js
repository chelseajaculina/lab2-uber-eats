  ...
  useEffect(() => {
    if (cart.length > 0) {
      ...
      if (uniqueRestaurantIds.length > 1) {
        console.warn('Multiple restaurant IDs found in the cart:', uniqueRestaurantIds);
        setErrorMessage('Your cart contains items from multiple restaurants. Please update your cart.');
      } else if (uniqueRestaurantIds[0]) {
        console.log('Setting restaurant_id:', uniqueRestaurantIds[0]);
