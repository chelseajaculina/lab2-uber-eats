...
const OrderPage = () => {
  ...
  // Fetch customer data and set IDs
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("Fetching customer and restaurant data using token...");
        ...
        setCustomerName(data.customer_name); // Assuming 'customer_name' is available in the session data
  ...
  const handlePlaceOrder = async () => {
    ...
    const orderPayload = {
      ...
      customer_name: customerName, // Include customer's name in the order
  ...
  return (
    <div className="order-page">
      ...
      {customerName && <p className="customer-name">Welcome, {customerName}!</p>} {/* Display customer's name */}
