...
class Order(models.Model):
    ...
    customer = models.CharField(max_length=100)  # Replace with ForeignKey if you have a Customer model
    dish = models.ManyToManyField(Dish, through='OrderItem')  # OrderItem handles quantity and price
    ...
    address = models.TextField()  # Add address to save the user's address
