...
class OrderViewSet(viewsets.ModelViewSet):
       ...
       def update_status(self, request, pk=None):
           ...
           delivery_status_choice = request.data.get('delivery_status')

           if status_choice in dict(Order.STATUS_CHOICES):
               order.status = status_choice
           if delivery_status_choice in dict(Order.DELIVERY_STATUS_CHOICES):
               order.delivery_status = delivery_status_choice
