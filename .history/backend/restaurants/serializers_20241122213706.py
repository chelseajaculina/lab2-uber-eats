...
class OrderSerializer(serializers.ModelSerializer):
    order_items = OrderDishSerializer(many=True, read_only=True)  # Include nested dishes

    class Meta:
        model = Order
        fields = ['id', 'restaurant', 'customer', 'address', 'total', 'status', 'delivery_status', 'order_date', 'order_items']
